...
extension AnyPublisher where Output == Result<Response, APIError>, Failure == Never {
    func map<T: Decodable>(_ type: T.Type) -> AnyPublisher<Result<T, APIError>, Never> {
        filterSuccessStatusCode()
    ...
    private func filterSuccessStatusCode() -> AnyPublisher<Result<Response, APIError>, Never> {
